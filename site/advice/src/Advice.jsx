...
const Advice = () => {
    ...
    return (
      ...
      >
        ...
        <h1 className="light-Cyan my-7 md:mt-5 text-center">
          &quot;{advice.advice}&quot;
        </h1>
        ...
        <button onClick={generate} className="bg-green rounded-full w-14 h-14 flex justify-center items-center absolute -bottom-7 ">
          <svg
            className=""
            width="18"
            height="18"
